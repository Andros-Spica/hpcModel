...
```{r 5_overview-collapsed-plot, include=FALSE}
...
```{r 5_rf-coevo-plots, include=FALSE}
#svg('plots/5_randomForest1.svg', width=10, height=10)
png("plots/5_multiplePar-rf-coevo.H.png")
varImpPlot(RF.coevo.H)
dev.off()

png("plots/5_multiplePar-rf-coevo.P.png")
varImpPlot(RF.coevo.P)
dev.off()
```

```{r 5_rf-coevo.H-plot-print, dependson='5_rf-coevo-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-coevo.H.png"))
```

```{r 5_rf-coevo.P-plot-print, dependson='5_rf-coevo-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-coevo.P.png"))
```
...
```{r 5_rf-depend-plots, include=FALSE}
#svg('plots/5_randomForest1.svg', width=10, height=10)
png("plots/5_multiplePar-rf-depend.H.png")
varImpPlot(RF.depend.H)
dev.off()

png("plots/5_multiplePar-rf-depend.P.png")
varImpPlot(RF.depend.P)
dev.off()
```

```{r 5_rf-depend.H-plot-print, dependson='5_rf-depend-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-depend.H.png"))
```

```{r 5_rf-depend.P-plot-print, dependson='5_rf-depend-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-depend.P.png"))
```
...
```{r 5_rf-timing-plots, include=FALSE}
#svg('plots/5_randomForest1.svg', width=10, height=10)
png("plots/5_multiplePar-rf-timing.H.png")
varImpPlot(RF.timing.H)
dev.off()

png("plots/5_multiplePar-rf-timing.P.png")
varImpPlot(RF.timing.P)
dev.off()
```

```{r 5_rf-timing.H-plot-print, dependson='5_rf-timing-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-timing.H.png"))
```

```{r 5_rf-timing.P-plot-print, dependson='5_rf-timing-plots', out.width = '100%'}
knitr::include_graphics(paste0("plots/5_multiplePar-rf-timing.P.png"))
```

## Scenarios

```{r 5_split-scenarios, include=FALSE, dependson='5_run-experiments-load'}
...
```{r 5_scenarios-humanImprove-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-humanImprove-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-humanImprove-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantImprove-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantImprove-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantImprove-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothImprove-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothImprove-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothImprove-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-humanLessBase-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-humanLessBase-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-humanLessBase-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantLessBase-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantLessBase-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-plantLessBase-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothLessBase-coevo-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothLessBase-depend-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
...
```{r 5_scenarios-bothLessBase-timing-plots, include=FALSE, dependson=c('5_run-experiments', '5_run-experiments-load', '5_split-scenarios')}
