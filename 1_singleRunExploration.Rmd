...
if(!file.exists('plots/runPlot/run.coevo.coeta-anim.gif'))
{
  ...
  # save
  save(run.coevo.coeta, file = 'data/run.coevo.coeta.RData')
}

# load
load('data/run.coevo.coeta.RData')
```
...
if(!file.exists('plots/runPlot/run.no.coevo-anim.gif'))
{
  ...
  # save
  save(run.no.coevo, file = 'data/run.no.coevo.RData')
...
if(!file.exists('plots/runPlot/run.coevo.early.cult-anim.gif'))
{
  ...
  # save
  save(run.coevo.early.cult, file = 'data/run.coevo.early.cult.RData')
...
# load
load('data/run.coevo.early.cult.RData')
...
if(!file.exists('plots/runPlot/run.coevo.early.dom-anim.gif'))
{
  ...
  # save
  save(run.coevo.early.dom, file = 'data/run.coevo.early.dom.RData')
...
# load
load('data/run.coevo.early.dom.RData')
...
if(!file.exists('plots/runPlot/run.cult.without.dom-anim.gif'))
{
  ...
  # save
  save(run.cult.without.dom, file = 'data/run.cult.without.dom.RData')
...
# load
load('data/run.cult.without.dom.RData')
...
if(!file.exists('plots/runPlot/run.coevo.bleep-anim.gif'))
{
  ...
  # save
  save(run.coevo.bleep, file = 'data/run.coevo.bleep.RData')
...
# load
load('data/run.coevo.bleep.RData')
...
if(!file.exists('plots/runPlot/run.coevo.boom-anim.gif'))
{
  ...
  # save
  save(run.coevo.boom, file = 'data/run.coevo.boom.RData')
...
# load
load('data/run.coevo.boom.RData')
...
if(!file.exists('plots/runPlot/run.coevo.long.boom-anim.gif'))
{
  ...
  # save
  save(run.coevo.long.boom, file = 'data/run.coevo.long.boom.RData')
...
# load
load('data/run.coevo.long.boom.RData')
...
if(!file.exists('plots/runPlot/run.semicoevo-anim.gif'))
{
  ...
  # save
  save(run.semicoevo, file = 'data/run.semicoevo.RData')
...
if(!file.exists('plots/runPlot/run.semicoevo.osc1-anim.gif'))
{
  ...
  # save
  save(run.semicoevo.osc1, file = 'data/run.semicoevo.osc1.RData')
...
# load
load('data/run.semicoevo.osc1.RData')
...
if(!file.exists('plots/runPlot/run.semicoevo.osc2-anim.gif'))
{
  ...
  # save
  save(run.semicoevo.osc2, file = 'data/run.semicoevo.osc2.RData')
...
# load
load('data/run.semicoevo.osc2.RData')
