...
```{r 2_mU.PnH, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_mU.PnH-values'), include=FALSE}
...
```{r 2_init.H, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_init-values'), include=FALSE}
...
```{r 2_init.P, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_init-values'), include=FALSE}
...
```{r 2_n.H, cache=TRUE, dependson=c('2_setup', '2_default-values','2_n-values'), include=FALSE}
...
```{r 2_n.P, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_n-values'), include=FALSE}
...
```{r 2_v.H, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_v-values'), include=FALSE}
...
```{r 2_v.P, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_v-values'), include=FALSE}
...
```{r 2_r.H, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_r-values'), include=FALSE}
...
```{r 2_r.P, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_r-values'), include=FALSE}
...
```{r 2_mU.HnP, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_mU.HnP-values'), include=FALSE}
...
```{r 2_mU.P1H, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_mU.P1H-values'), include=FALSE}
...
```{r 2_mU.H1P, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_mU.H1P-values'), include=FALSE}
...
```{r 2_U.bH1, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_U.bH1-values'), include=FALSE}
...
```{r 2_U.bP1, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_U.bP1-values'), include=FALSE}
...
```{r 2_U.bHn, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_U.bHn-values'), include=FALSE}
...
```{r 2_U.bPn, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_U.bPn-values'), include=FALSE}
...
```{r 2_MaxArea, cache=TRUE, dependson=c('2_setup', '2_default-values', '2_MaxArea-values'), include=FALSE}
