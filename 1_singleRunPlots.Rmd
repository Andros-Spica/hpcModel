...
```{r 1_run.coevo.coeta-ggplot-print, echo=FALSE, dependson='run.coevo.coeta-ggplot'}
...
```{r 1_run.coevo.coeta-frames, warning=FALSE, dependson='1_run.coevo.coeta-name'}
run2 <- hpcModel.run(
  # initial populations
  iniH = 10,
  iniP = 10,
...
```{r 1_run.coevo.coeta-animation, echo=FALSE, dependson='run.coevo.coeta-frames'}
...
```{r 1_run.no.coevo-animation, echo=FALSE, dependson='run.no.coevo'}
...
```{r 1_run.coevo.early.cult-animation, echo=FALSE, dependson='run.coevo.early.cult'}
...
```{r 1_run.coevo.early.dom-animation, echo=FALSE, dependson='run.coevo.early.dom'}
...
```{r 1_run.cult.without.dom-animation, echo=FALSE, dependson='run.cult.without.dom'}
...
```{r 1_run.coevo.bleep-animation, echo=FALSE, dependson='run.coevo.bleep'}
...
```{r 1_run.coevo.boom-animation, echo=FALSE, dependson='run.coevo.boom'}
...
```{r 1_run.coevo.long.boom-animation, echo=FALSE, dependson='run.coevo.long.boom'}
