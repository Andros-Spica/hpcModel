...
```{r 2mUPnHtablehtml, eval=!params$ispdf, cache=TRUE, dependson='2_mU.PnH'}
exp.table(exp.mU.PnH, caption = 'Parameter setting')
```

```{r 2mUPnHtablepdf, eval=params$ispdf, cache=TRUE, dependson='2_mU.PnH'}
...
```{r 2_mU.HnP.osc, cache=TRUE, dependson='2_osc-values', include=FALSE}
if(!file.exists('data/2_mU.HnP.osc.RData'))
{
  ...
  # save
  save(result.mU.HnP.H, file = 'data/2_mU.HnP.H.osc.RData')
  save(result.mU.HnP.P, file = 'data/2_mU.HnP.P.osc.RData')
}
```

```{r 2_mU.HnP.osc-load, include=FALSE}
# load
load('data/2_mU.HnP.H.osc.RData')
load('data/2_mU.HnP.P.osc.RData')
```

```{r 2_mU.HnP.osc-bifplot2, cache=TRUE, dependson='2_mU.HnP_mU.PnH.osc-load', results='hide'}
plotScale = 10
...
```{r 2_mU.PnH.osc, cache=TRUE, dependson='2_osc-values', include=FALSE}
if(!file.exists('data/2_mU.PnH.osc.RData'))
{
...
# save
  save(result.mU.HnP.H, file = 'data/2_mU.PnH.H.osc.RData')
  save(result.mU.HnP.P, file = 'data/2_mU.PnH.P.osc.RData')
}
```

```{r 2_mU.PnH.osc-load, include=FALSE}
# load
load('data/2_mU.PnH.H.osc.RData')
load('data/2_mU.PnH.P.osc.RData')
```

```{r 2_mU.PnH.osc-bifplot2, cache=TRUE, dependson='2_mU.PnH.osc', results='hide'}
plotScale = 10
