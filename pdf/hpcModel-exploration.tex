...
- \emph{Domestication without cultivation} (red square in whitish tile): most cases when \(\bar{U}_{H_{n}P}>0.625\), \(\bar{U}_{H_{1}P}\geq 0.625\), \(\bar{U}_{P_{n}H}=0\), and \(\bar{U}_{P_{1}H}<3\).\\
...
\textbf{\emph{Interpretation}}:\\
- As a summary of possible end-states:\\
- \emph{`Fast' coevolution} (red square in blue tile, small \emph{t}): .\\
- \emph{Domestication without cultivation} (red square in whitish tile): .\\
- \emph{Cultivation without domestication} (whitish square in blue tile): .
...
\hypertarget{random-forest-manual-tuning}{%
\section{Random forest (manual tuning)}\label{random-forest-manual-tuning}}
