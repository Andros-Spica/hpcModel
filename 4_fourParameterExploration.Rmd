...
```{r 4_mU.HP_mU.PH, cache=TRUE, dependson=c('4_setup','4_default-values','4_mU.HP_mU.PH-values'), results = 'hide'}
...
```{r 4_mU.HP_mU.PH-table, cache=TRUE, dependson=c('4_table-functions','4_mU.HP_mU.PH')}
exp.table(exp.mU.HP_mU.PH)
```
...
```{r 4_U.bH_U.bP, cache=TRUE, dependson=c('4_setup','4_default-values','4_U.bH_U.bP-values'), results = 'hide'}
...
```{r 4_U.bH_U.bP-table, cache=TRUE, dependson=c('4_table-functions','4_U.bH_U.bP')}
exp.table(exp.U.bH_U.bP)
```
...
```{r 4_n_v, cache=TRUE, dependson=c('4_setup','4_default-values','4_n_v-values'), results = 'hide'}
...
```{r 4_n_v-table, cache=TRUE, dependson=c('4_table-functions','4_n_v')}
exp.table(exp.n_v)
```
