...
```{r cover-logo, echo=FALSE, eval=!params$ispdf, out.width = '80%', fig.align='center'}
...
```{r infographic, echo=FALSE, out.width = '80%', fig.align='center', fig.cap='Human-plant coevolution dynamics'}
...
```{r forrester-diagram, echo=FALSE, out.width = '100%', fig.align='center', fig.cap='The HPC model (Forrester diagram)'}
