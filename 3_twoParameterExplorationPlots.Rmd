...
### Utility per capita from type n humans and plants ($\bar{U}_{H_{n}P}\,vs\,\bar{U}_{P_{n}H}$):
...
### Undirected variation in humans and plants ($v_{H}\,vs\,v_{P}$):
...
### Utility per capita from type 1 humans and plants ($\bar{U}_{H_{1}P}\,vs\,\bar{U}_{P_{1}H}$):
...
```{r 3_mU.HnP_mU.PnH-plot-print2, echo=FALSE}
knitr::include_graphics(paste0("plots/3_twoPar-", exp.mU.HnP_mU.PnH.name, "_plot.png"))
```

### Utility per capita from humans to plants ($\bar{U}_{H_{1}P}\,vs\,\bar{U}_{H_{n}P}$):
...
```{r 3_mU.H1P_mU.HnP, cache=TRUE, dependson='3_mU.H1P_mU.HnP-values', include=FALSE}
...
```{r 3_mU.H1P_mU.HnP-plot-print, echo=FALSE}
knitr::include_graphics(paste0("plots/3_twoPar-", exp.mU.H1P_mU.HnP.name, "_plot.png"))
```

### Utility per capita from plants to humans ($\bar{U}_{P_{1}H}\,vs\,\bar{U}_{P_{n}H}$):
...
```{r 3_mU.P1H_mU.PnH, cache=TRUE, dependson='3_mU.P1H_mU.PnH-values', include=FALSE}
...
```{r 3_mU.P1H_mU.PnH-plot-print, echo=FALSE}
knitr::include_graphics(paste0("plots/3_twoPar-", exp.mU.P1H_mU.PnH.name, "_plot.png"))
```

### Utility of other resources to type 1 humans and plants ($U_{bH_{1}}\,vs\,U_{bP_{1}}$):
...
### Utility of other resources to type n humans and plants ($U_{bH_{n}}\,vs\,U_{bP_{n}}$):
...
### Utility of other resources to humans ($U_{bH_{1}}\,vs\,U_{bH_{n}}$):
...
```{r 3_U.bH1_U.bHn, cache=TRUE, dependson='3_U.bH1_U.bHn-values', include=FALSE}
...
```{r 3_U.bH1_U.bHn-plot-print, echo=FALSE}
knitr::include_graphics(paste0("plots/3_twoPar-", exp.U.bH1_U.bHn.name, "_plot.png"))
```

### Utility of other resources to plants ($U_{bP_{1}}\,vs\,U_{bP_{n}}$):
...
```{r 3_U.bP1_U.bPn, cache=TRUE, dependson='3_U.bP1_U.bPn-values', include=FALSE}
...
```{r 3_U.bP1_U.bPn-plot-print, echo=FALSE}
