...
cover-image: "images/hpcModel-logo.png"
output:
  bookdown::gitbook:
    lib_dir: assets
    split_by: section
    config:
      ...
      before: |
        <li><a href="...">Human-Plant model - documentation and exploration</a></li>
        <li><a href="...">Andreas Angourakis & Jonàs Alcaina</a></li>
      after: |
...
**_Output end-state variables_**
 ...
 `coevo.H`, `coevo.P`   | $$coevo_{H},\,coevo_{P}$$ | Coevolution coefficients. A coefficient representing the distribution of the proportions of population per type (`pop.A1` to `pop.An`) weighted by type index (`1` to `n`). Each indicates *if* and *how much* the population distribution has been modified by the coevolutionary process. Their values range between -1, the entire population is of type 1, and 1, the entire population is of type n.
